...
const CFAdminActionGenerator = require('../src/generator-add-action-cf-editor')
const CFAdminWebAssetsGenerator = require('../src/generator-add-web-assets-cf-editor')
...
describe('run', () => {
  const srcFolder = 'src/aem-cf-editor-1'
  const configName = 'aem/cf-editor/1'
